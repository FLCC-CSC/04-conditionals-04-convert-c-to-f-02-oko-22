...
# DATE: 03/02/2026
# BRIEF DESCRIPTION: Converting temparatures 
...
def main():
    cel_and_fah_converter()

def cel_and_fah_converter():
...
One lesson that I learned was how to create an interactive menu.
